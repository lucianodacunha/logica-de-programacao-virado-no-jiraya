package net.lucianodacunha.aula10;
...
public class CalculaPercentualDeSalario {
    public static void main(String[] args){
        ...
        System.out.println("Valor Calculado 1: " + valorCalculado);

        System.out.print("Entre com o valor do salario: ");
        valorInicialDeSalario = entrada.nextDouble();
        valorCalculado = valorInicialDeSalario * percentual;
        System.out.println("Valor Calculado 2: " + valorCalculado);
